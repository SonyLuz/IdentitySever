...
using DemoIdentityServer.Code;
using DemoIdentityServer.Models;
using DemoIdentityServer.Models.Account;
using DemoIdentityServer.Models.Consent;
    ...
    public class ConsentController : Controller
    {
        ...
        private async Task<ProcessConsentResult> ProcessConsent(ConsentInputModel model)
        {
            ...
            if (model.Button == "no")
            {
                ...
                // emit event
                await _events.RaiseAsync(new ConsentDeniedEvent(User.GetSubjectId(), result.ClientId, request.Client.AllowedScopes));
            }
